...
<body>
  <?php require"processLogin.php"?>
    ...
    <div style="height: 500px;padding-top:200px;">
        <h2 style="color:blueviolet;text-align:center;font-weight: 700;">Đăng kí thành công</h2>
        <h2 style="color:blueviolet;text-align:center;font-weight: 700;">Vui lòng kiểm tra Mail "<?php echo $_GET['email'] ?>" để kích hoạt tài khoản...</h2>
    </div>
        <!-- footer -->
        <footer id="footer">
    <div class="container">
