...
function getGooglePaymentDataRequest() { 
    ...
    paymentDataRequest.merchantInfo = {   // @todo a merchant ID is available for a production environment after approval by Google
           // See {@link https://developers.google.com/pay/api/web/guides/test-and-deploy/integration-checklist|Integration checklist}
           // merchantId: '01234567890123456789',
          
        merchantName: 'Example Merchant',
        merchantId: '2873-1353-9787'
    };
...
function onPaymentAuthorized(paymentData) {
    return new Promise(function(resolve, reject) {   // handle the response
          
        processPayment(paymentData)
            .then(function() {
                resolve({ transactionState: 'SUCCESS' });
                // TODO:turn back to menu
...
function addGooglePayButton() { 
    ...
    document.getElementById('btn-payment').appendChild(button);
}
...
function getGoogleTransactionInfo() { 
    var price = document.getElementById('total-bill').innerHTML.split('.').join('');
    var price_usd = price / 24000;
    ...
    return {    
        ...
          
        totalPrice: price_usd.toFixed(2),
          
